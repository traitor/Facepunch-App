...
/**
 * This is a base class for activites belonging to this application. It contains
 * the header and some additional utility code.
 * 
 * @author Overv
 */
public class FPActivity extends Activity {
	...
	// Inheriting activities can prevent the user button from appearing, e.g. in
	// the login activity
	...
	public void onContentChanged() {
		// Set up user button if it isn't suppressed and there is a user logged
		// in
		if (!suppressUserButton && api.loggedIn()) {
			...
			userButton.setOnClickListener(new Button.OnClickListener() {
				public void onClick(View v) {
					...
					final CharSequence[] items = { getString(R.string.privateMessagingTitle), getString(R.string.preferences), getString(R.string.logout) };

					new AlertDialog.Builder(FPActivity.this).setTitle(api.username()).setItems(items, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int item) {
							if (item == 0) { // PMs
								 ...
								 * 
								 * if (success) { Intent intent = new Intent(
								 * FPActivity.this, LoginActivity.class );
								 * intent.putExtra("reset", true);
								 * startActivity(intent); } else {
								 * Toast.makeText( FPActivity.this, getString(
								 * R.string.loggingOutFailed ),
